...
export class TourismComponent {
  ...
  loadFilteredTemples() {
    ...
    if (this.selectedCategoryId && this.selectedLocationId) {
      ...
      this.templeserviceservice.tourisms(this.selectedLocationId, this.currentPage).subscribe(
        (response) => {
          this.globaltemples = response.tourism_places;
      ...
      this.templeserviceservice.getalltourism().subscribe(
        (response) => {
          this.globaltemples = response.tourism_places;
  ...
  loadlocations(): void {
    ...
    this.locationservice.countrytourism('tourism').subscribe(
      (res) => {
