...
@Component({
  ...
  templateUrl: './add-verticnary.component.html',
  styleUrl: './add-verticnary.component.css'
})
export class AddVerticnaryComponent {
...
existingVillageId: string | null = null;
  ...
  constructor(private templeservice:TempleserviceService, private route:ActivatedRoute,
    ...
    private renderer: Renderer2,private spinner: NgxSpinnerService, public dialogRef: MatDialogRef<AddVerticnaryComponent>,
...
loadvectinaryEdit(): void {
  this.spinner.show();

  this.templeservice.getvertinaryhospitalsbyid(this.tourismId).subscribe(
    (res) => {
...
this.spinner.show();
  ...
  if (this.isEditMode && this.tourismId) {
    ...
    this.goshalaservice.updatevectinaryhospital(this.tourismId, payload)
      .subscribe({
        next: () => {
          console.log('UPDATE SUCCESS');
          this.spinner.hide();
          this.notificationHelper.showSuccessNotification('Veterinary Hospital updated successfully');
    ...
    this.goshalaservice.addvectinaryhospital(payload)
      .subscribe({
        next: () => {
          console.log('ADD SUCCESS');
          this.spinner.hide();
          this.notificationHelper.showSuccessNotification('Veterinary Hospital added successfully');
...
private HotelresetFormFields(fields: string[]) {
 ...
 Uploadvetinaryhospitalimage(info:NzUploadChangeParam):void {
