...
import { AddVerticnaryComponent } from '../add-verticnary/add-verticnary.component';
@Component({
  selector: 'app-vertinary-hospitals',
  standalone: true,
  ...
  templateUrl: './vertinary-hospitals.component.html',
  styleUrl: './vertinary-hospitals.component.css'
})
export class VertinaryHospitalsComponent {
    ...
    constructor(
      ...
      private eRef: ElementRef, private dialog: MatDialog,private dialogService: DialogService
    ...
    loadFilteredTemples() {
      ...
      if (this.selectedCategoryId && this.selectedLocationId) {
        ...
        this.templeserviceservice.vertinaryhospitals(this.selectedLocationId, this.currentPage).subscribe(
          (response) => {
            this.globaltemples = response.veterinary_hospitals;
        ...
        this.templeserviceservice.getallvertinaryhospitals().subscribe(
          (response) => {
    ...
    loadlocations(): void {
      ...
      this.locationservice.countryveterinary('veterinary_hospital').subscribe(
        (res) => {
...
// OpenVetHospitalDialog() {
//   this.dialogService.open('vet');
// }

  
    // OpenVetHospitalDialog(): void {
    //   const dialogRef = this.dialog.open(AddVerticnaryComponent, {
 ...
 dialogRef!: MatDialogRef<any>;
    ...
    this.templeserviceservice.getvertinaryhospitalsbyid(id).subscribe({
      next: (res) => {
    ...
    edithotel(hotel: any): void {
      ...
      dialogRef.afterClosed().subscribe(result => {
        if (result === 'updated') {
          this.openvertinaryhospitalsDialog(hotel._id);
        }
      });
    }
